package ru.samitin.mytranslater.view.descriptionScreen
...
import ru.samitin.mytranslater.databinding.ActivityDescriptionBinding
...
class DescriptionActivity : AppCompatActivity() {
    ...
    private fun setActionbarHomeButtonAsUp() {
        supportActionBar?.setHomeButtonEnabled(true)//Установить домашнюю кнопку включена
        supportActionBar?.setDisplayHomeAsUpEnabled(true)//Установить отображение домой как включено
    }
